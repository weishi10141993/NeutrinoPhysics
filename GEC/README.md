...
source /gpfs/scratch/<netID>/ups/setup                                                   
# You can use mine as I've installed it: source /gpfs/scratch/weishi2/ups/setup
setup git
setup gitflow
setup mrb
setup dunetpc v09_22_02 -q e19:debug
...
export MRB_PROJECT=larsoft                                                               # Need to set ${MRB_PROJECT} to the master product
mrb newDev
source /gpfs/home/weishi2/FDEff/localProducts_larsoft_v09_22_02_debug_e19/setup
