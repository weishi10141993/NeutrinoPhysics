...
*/	
	...
	std::cout << "eDepPipplane2:" << eDepPipplane2 << std::endl;
		std::cout << "ePip:" << ePip1 << std::endl;
	std::cout << "eDepPimplane2:" << eDepPimplane2 << std::endl;
		std::cout << "ePim:" << ePim1 << std::endl;
		std::cout << "pipI:" << pipI << std::endl;
		std::cout << "pimI:" << pimI << std::endl;
    fTree->Fill();
	pipdecay = 0;
	pimdecay = 0;
	eDecay = 0;
